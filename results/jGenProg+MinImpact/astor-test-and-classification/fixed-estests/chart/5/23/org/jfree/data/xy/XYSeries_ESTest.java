...
public class XYSeries_ESTest extends XYSeries_ESTest_scaffolding {
    ...
    public void test009() throws Throwable {
        ...
        Assert.assertTrue(xYSeries0.getAutoSort());
        Assert.assertEquals((-321.0415293898), xYDataItem0.getYValue(), 0.01);
        Assert.assertEquals(2147483647, xYSeries0.getMaximumItemCount());
        Assert.assertTrue(xYSeries0.getAllowDuplicateXValues());
    ...
    public void test010() throws Throwable {
        ...
        XYDataItem xYDataItem0 = xYSeries0.remove(0);
        Assert.assertEquals(1285.4394926261, xYDataItem0.getXValue(), 0.01);
        Assert.assertEquals(2147483647, xYSeries0.getMaximumItemCount());
        Assert.assertTrue(xYSeries0.getAllowDuplicateXValues());
        Assert.assertTrue(xYSeries0.getAutoSort());
        Assert.assertEquals(1285.4394926261, xYDataItem0.getYValue(), 0.01);
    }
    ...
    public void test013() throws Throwable {
        ...
        Assert.assertEquals(1.439700122492924, ((double) (double0)), 0.01);
    }
    ...
    public void test018() throws Throwable {
        ...
        XYDataItem xYDataItem0 = xYSeries0.getDataItem(0);
        Assert.assertEquals(200.0, xYDataItem0.getYValue(), 0.01);
        Assert.assertTrue(xYSeries0.getAutoSort());
        Assert.assertEquals(2147483647, xYSeries0.getMaximumItemCount());
        Assert.assertTrue(xYSeries0.getAllowDuplicateXValues());
    }
