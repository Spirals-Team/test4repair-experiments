...
public class FDistributionImpl_ESTest extends FDistributionImpl_ESTest_scaffolding {
    ...
    public void test02() throws Throwable {
        ...
        Assert.assertEquals(1.0012192184303985, double0, 0.01);
        Assert.assertEquals(1642.3951499866528, fDistributionImpl0.getNumeratorDegreesOfFreedom(), 0.01);
    }
    ...
    public void test05() throws Throwable {
        ...
        Assert.assertEquals(4.086844028776982E-28, fDistributionImpl0.getDenominatorDegreesOfFreedom(), 0.01);
    }
    ...
    public void test08() throws Throwable {
        ...
        Assert.assertEquals(5049.547228009174, fDistributionImpl0.getNumeratorDegreesOfFreedom(), 0.01);
        Assert.assertEquals((-1.2823075934420558E-12), double0, 0.01);
    }
    ...
    public void test10() throws Throwable {
        ...
        Assert.assertEquals(4.086844028776982E-28, double0, 0.01);
    }
    ...
    public void test13() throws Throwable {
        ...
        Assert.assertEquals(843.67217599499, fDistributionImpl0.getDenominatorDegreesOfFreedom(), 0.01);
    ...
    public void test14() throws Throwable {
        ...
        Assert.assertEquals(1015.0018, fDistributionImpl0.getDenominatorDegreesOfFreedom(), 0.01);
        Assert.assertEquals(1015.0018, fDistributionImpl0.getNumeratorDegreesOfFreedom(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test15() throws Throwable {
        ...
        Assert.assertEquals(14.72692409602326, fDistributionImpl0.getNumeratorDegreesOfFreedom(), 0.01);
        Assert.assertEquals(14.72692409602326, fDistributionImpl0.getDenominatorDegreesOfFreedom(), 0.01);
    }
    ...
    public void test17() throws Throwable {
        FDistributionImpl fDistributionImpl0 = new FDistributionImpl(4.086844028776982E-28, 4.086844028776982E-28);
        double double0 = fDistributionImpl0.cumulativeProbability(4.086844028776982E-28);
        Assert.assertEquals(0.5000000000000027, double0, 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        // AssertFixer: old assertion Assert.assertEquals((-2.043422014388491E-28), double0, 0.01)
