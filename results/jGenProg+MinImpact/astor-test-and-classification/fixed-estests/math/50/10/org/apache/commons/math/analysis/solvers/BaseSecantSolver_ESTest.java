...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals(843.699244411, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1.0, double0, 0.01);
    }
    ...
    public void test05() throws Throwable {
        ...
        Assert.assertEquals((-3.1685906910737877E-13), pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-989.0), double0, 0.01);
    }
    ...
    public void test06() throws Throwable {
        ...
        Assert.assertEquals((-291.995921), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test07() throws Throwable {
        ...
        double double0 = illinoisSolver0.doSolve();
        Assert.assertEquals(6.792695603162321E10, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-3894.6614594223483), double0, 0.01);
    }
    ...
    public void test20() throws Throwable {
        try {
            ...
            Assert.assertEquals((-297.04325649193095), regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals((-593.7610115284696), double0, 0.01);
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals(3187.4747344658635, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(2894.625014446977, double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals(3188.215814478934, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(2158.342523328399, double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        Assert.assertEquals(2117.24, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(14.0, double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals(3188.215814478934, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(3706.8880180780557, double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        ...
        Assert.assertEquals(3188.3255499999996, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(3427.0546428466746, double0, 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        Assert.assertEquals((-285.5531564355587), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-568.6282702997526), double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        double double0 = regulaFalsiSolver0.solve(15, ((UnivariateRealFunction) (sincFunction0)), (-571.1063128825477), 1.1430250008909141E-8, allowedSolution0);
        Assert.assertEquals((-285.5531564355587), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-568.6282702999328), double0, 0.01);
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals((-989.6016858807849), double0, 0.01);
    }
    ...
    public void test29() throws Throwable {
        ...
        Assert.assertEquals(1893.891, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.3478782261948307, double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        Assert.assertEquals((-0.6668674526234742), regulaFalsiSolver0.getMax(), 0.01);
        Assert.assertEquals((-568.6282702997526), double0, 0.01);
    }
    ...
    public void test31() throws Throwable {
        ...
        Assert.assertEquals(0.14271745685195, pegasusSolver0.getMin(), 0.01);
    ...
    public void test33() throws Throwable {
        ...
        Assert.assertEquals((-247.65000000000003), illinoisSolver0.getStartValue(), 0.01);
    ...
    public void test35() throws Throwable {
        ...
        Assert.assertEquals((-1435.0), pegasusSolver0.getMax(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
