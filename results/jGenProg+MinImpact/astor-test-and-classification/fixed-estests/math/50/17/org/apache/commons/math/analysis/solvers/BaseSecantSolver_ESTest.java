...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test02() throws Throwable {
        ...
        Assert.assertEquals(128.0, illinoisSolver0.getMin(), 0.01);
    ...
    public void test18() throws Throwable {
        try {
            ...
            Assert.assertEquals((-2850.0649623355), regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals(2.7863694426442738, double0, 0.01);
    ...
    public void test19() throws Throwable {
        ...
        Assert.assertEquals(5.440208786493529E8, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(501.084028247572, double0, 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        Assert.assertEquals((-526.2616860927235), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1050.3452330740047), double0, 0.01);
    }
    ...
    public void test21() throws Throwable {
        try {
            ...
            Assert.assertEquals(59.0, regulaFalsiSolver0.getMin(), 0.01);
    ...
    public void test22() throws Throwable {
        ...
        double double0 = regulaFalsiSolver0.solve(71, univariateRealFunction0, ((double) (71)), 1295.5181, 5.440208786493529E8, allowedSolution0);
        Assert.assertEquals(5.440208786493529E8, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(620.8735189659405, double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        double double0 = regulaFalsiSolver0.solve(71, univariateRealFunction0, ((double) (71)), 1295.5181, 5.440208786493529E8, allowedSolution0);
        Assert.assertEquals(5.440208786493529E8, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(71.0, double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals((-531.9585015), regulaFalsiSolver0.getStartValue(), 0.01);
    ...
    public void test25() throws Throwable {
        ...
        Assert.assertEquals(1049.0, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1925.7962966505427, double0, 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        Assert.assertEquals(438.0, regulaFalsiSolver0.getStartValue(), 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals(1057.5, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(260.7521902479488, double0, 0.01);
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals(1.0E-12, regulaFalsiSolver0.getMax(), 0.01);
        Assert.assertEquals((-648.7388829662923), double0, 0.01);
    }
    ...
    public void test29() throws Throwable {
        ...
        Assert.assertEquals(1238.03110926525, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1473.4069545336129, double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        Assert.assertEquals((-235.306258), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1.0000000000020568, double0, 0.01);
    }
    ...
    public void test32() throws Throwable {
        ...
        AllowedSolution allowedSolution0 = AllowedSolution.RIGHT_SIDE;
        double double0 = regulaFalsiSolver0.solve(71, univariateRealFunction0, ((double) (71)), 1295.5181, 5.440208786493529E8, allowedSolution0);
        Assert.assertEquals(71.0, regulaFalsiSolver0.getMin(), 0.01);
        Assert.assertEquals(620.8735189659405, double0, 0.01);
    }
    ...
    public void test33() throws Throwable {
        ...
        Assert.assertEquals((-98.903046989815), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(5.0, double0, 0.01);
    }
    ...
    public void test35() throws Throwable {
        ...
        Assert.assertEquals(129.0000000198682, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(5.0, double0, 0.01);
    }
