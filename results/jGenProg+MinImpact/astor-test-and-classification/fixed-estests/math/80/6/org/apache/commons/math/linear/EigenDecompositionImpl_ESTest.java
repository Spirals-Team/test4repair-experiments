...
public class EigenDecompositionImpl_ESTest extends EigenDecompositionImpl_ESTest_scaffolding {
    ...
    public void test02() throws Throwable {
        ...
        Assert.assertEquals(629.161, double0, 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals((-374.96280066319), double0, 0.01);
        Assert.assertEquals(0.0, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test05() throws Throwable {
        ...
        Assert.assertEquals(2.07051965616157408E17, double0, 0.01);
    }
    ...
    public void test06() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, 5811.7274);
        double double0 = eigenDecompositionImpl0.getDeterminant();
        Assert.assertEquals((-2.873597877377184E17), double0, 0.01);
    }
    ...
    public void test10() throws Throwable {
        ...
        Assert.assertEquals(2.07051965616157408E17, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test13() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, 0.0);
        Assert.assertEquals((-4.253729269808159E23), eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test16() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, 0.0);
        Assert.assertEquals((-3.7402789569500594E9), eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        doubleArray1[7] = 14.55485122642604;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, 0.0);
        Assert.assertEquals(2.6995196305339753, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        doubleArray1[7] = 3594.7;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1.5515636572620746));
        // AssertFixer: old assertion Assert.assertEquals(2.678656082847259E30, eigenDecompositionImpl0.getDeterminant(), 0.01)
        Assert.assertEquals(1.8312325829520418E21, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
}
