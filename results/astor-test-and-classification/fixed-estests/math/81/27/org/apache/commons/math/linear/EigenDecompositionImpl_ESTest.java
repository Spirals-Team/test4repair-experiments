...
public class EigenDecompositionImpl_ESTest extends EigenDecompositionImpl_ESTest_scaffolding {
    ...
    public void test00() throws Throwable {
        ...
        Assert.assertEquals(4628845.457771763, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals(1.8883453332117344, double0, 0.01);
        Assert.assertEquals((-0.0), eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test07() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, 130.8502);
        double double0 = eigenDecompositionImpl0.getDeterminant();
        Assert.assertEquals((-313.8539055765291), double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        doubleArray1[6] = 1.3322676295501878E-15;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, 0.0);
        Assert.assertEquals((-6.282960153190823E25), eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        doubleArray1[1] = -1.8883453332117344;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1.8883453332117344));
        Assert.assertEquals(6.733552613785326, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
