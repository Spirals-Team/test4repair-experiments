...
public class EigenDecompositionImpl_ESTest extends EigenDecompositionImpl_ESTest_scaffolding {
    ...
    public void test05() throws Throwable {
        ...
        Assert.assertEquals(4.905109723557369, double0, 0.01);
    }
    ...
    public void test06() throws Throwable {
        ...
        Assert.assertEquals((-1484.162582190289), double0, 0.01);
    }
    ...
    public void test08() throws Throwable {
        ...
        Assert.assertEquals(2.7809090784234084E7, double0, 0.01);
    }
    ...
    public void test09() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1740.34048967));
        double double0 = eigenDecompositionImpl0.getDeterminant();
        Assert.assertEquals((-7.556734411480142E9), double0, 0.01);
    }
    ...
    public void test12() throws Throwable {
        ...
        Assert.assertEquals(2.7809090784234084E7, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test13() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1740.34048967));
        Assert.assertEquals(8.675029332116537E7, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test15() throws Throwable {
        ...
        doubleArray1[5] = 4680.29667262757;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1.1805021219105152));
        Assert.assertEquals((-4.0726826837269E25), eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test16() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1.1805021219105152));
        Assert.assertEquals(6.829372571073333E22, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test17() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1.1805021219105152));
        Assert.assertEquals(6.984082919827801E22, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        doubleArray1[5] = 976.5507161228577;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1.1805021219105152));
        Assert.assertEquals(2.7897940361060705E25, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
