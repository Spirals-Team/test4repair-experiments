...
public class EigenDecompositionImpl_ESTest extends EigenDecompositionImpl_ESTest_scaffolding {
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals(900601.0, double0, 0.01);
    }
    ...
    public void test05() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1044.4500862122));
        double double0 = eigenDecompositionImpl0.getDeterminant();
        Assert.assertEquals((-1.8593048291745013E11), double0, 0.01);
    }
    ...
    public void test11() throws Throwable {
        ...
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-715.74644));
        Assert.assertEquals(2.8191361818957745E20, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test12() throws Throwable {
        ...
        doubleArray1[6] = 1238.7428479796324;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-715.74644));
        Assert.assertEquals(7.139166360314544E25, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test16() throws Throwable {
        ...
        doubleArray1[4] = 1960.9974;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1044.4500862122));
        // AssertFixer: old assertion Assert.assertEquals((-5.8538735893222515E19), eigenDecompositionImpl0.getDeterminant(), 0.01)
        Assert.assertEquals(4.220673468273433E19, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        doubleArray1[5] = 1238.7428479796324;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-715.74644));
        // AssertFixer: old assertion Assert.assertEquals((-4.0848361709782137E24), eigenDecompositionImpl0.getDeterminant(), 0.01)
        Assert.assertEquals(1.532942781218046E23, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        doubleArray1[6] = 2.0;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-715.74644));
        // AssertFixer: old assertion Assert.assertEquals((-1.8535154748747246E24), eigenDecompositionImpl0.getDeterminant(), 0.01)
        Assert.assertEquals(-1.4757765350409605E19, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        doubleArray1[4] = 1960.9974;
        EigenDecompositionImpl eigenDecompositionImpl0 = new EigenDecompositionImpl(doubleArray0, doubleArray1, (-1044.4500862122));
        // AssertFixer: old assertion Assert.assertEquals((-1.5726691661396038E12), eigenDecompositionImpl0.getDeterminant(), 0.01)
        Assert.assertEquals(4.352947292815568E11, eigenDecompositionImpl0.getDeterminant(), 0.01);
    }
}
