...
public class BisectionSolver_ESTest extends BisectionSolver_ESTest_scaffolding {
    ...
    public void test00() throws Throwable {
        ...
        Assert.assertEquals(1059.47193491, double0, 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals((-248.18581951635093), double0, 0.01);
    }
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals(30, bisectionSolver0.getIterationCount());
        Assert.assertEquals((-6.726727999213633E-9), double0, 0.01);
    }
    ...
    public void test06() throws Throwable {
        ...
        Assert.assertEquals((-2154.2386151308574), double0, 0.01);
    }
    ...
    public void test19() throws Throwable {
        ...
        BisectionSolver bisectionSolver0 = new BisectionSolver(((UnivariateRealFunction) (sinFunction0)));
        bisectionSolver0.solve(1.944396294666726E-6, 0.00634765625, 0.00634765625);
        Assert.assertEquals(12, bisectionSolver0.getIterationCount());
    }
    ...
    public void test02() throws Throwable {
        ...
        // AssertFixer: old assertion Assert.assertEquals(62, monitoredFunction0.getCallsCount())
        Assert.assertEquals(0, monitoredFunction0.getCallsCount());
        // AssertFixer: old assertion Assert.assertEquals((-509.7548002543864), double0, 0.01)
        Assert.assertEquals(-509.7548002543864, double0, 0.01);
    }
