...
public class FDistributionImpl_ESTest extends FDistributionImpl_ESTest_scaffolding {
    ...
    public void test05() throws Throwable {
        ...
        Assert.assertEquals(1.3144917552772624, fDistributionImpl0.getDenominatorDegreesOfFreedom(), 0.01);
        Assert.assertEquals(3075.217636058085, fDistributionImpl0.getNumeratorDegreesOfFreedom(), 0.01);
    ...
    public void test07() throws Throwable {
        ...
        Assert.assertEquals(0.004556155712216393, double0, 0.01);
    }
    ...
    public void test09() throws Throwable {
        ...
        Assert.assertEquals((-4.860556401808935E-13), double0, 0.01);
    }
    ...
    public void test12() throws Throwable {
        ...
        Assert.assertEquals(1.3144917552772624, double0, 0.01);
        Assert.assertEquals(3075.217636058085, fDistributionImpl0.getNumeratorDegreesOfFreedom(), 0.01);
    }
    ...
    public void test13() throws Throwable {
        ...
        Assert.assertEquals(0.9999999999999971, double0, 0.01);
