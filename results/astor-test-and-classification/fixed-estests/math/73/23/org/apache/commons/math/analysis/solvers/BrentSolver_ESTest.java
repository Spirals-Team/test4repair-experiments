...
public class BrentSolver_ESTest extends BrentSolver_ESTest_scaffolding {
    ...
    public void test00() throws Throwable {
        ...
        Assert.assertEquals(37, brentSolver0.getIterationCount());
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals((-8.039661201019923E-9), double0, 0.01);
    }
    ...
    public void test17() throws Throwable {
        ...
        Assert.assertEquals(35, brentSolver0.getIterationCount());
        Assert.assertEquals((-0.9999998751793487), double0, 0.01);
    }
    ...
    public void test18() throws Throwable {
        ...
        double double0 = brentSolver0.solve(((UnivariateRealFunction) (quinticFunction0)), (-1563.487551), 598.79117177018);
        Assert.assertEquals(26, brentSolver0.getIterationCount());
        Assert.assertEquals(0.8970580407012179, double0, 0.01);
    }
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals((-1563.487551), double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        Assert.assertEquals((-564.031753849), double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        try {
            ...
            Assert.assertEquals(1840.1144881656403, double0, 0.01);
            org.junit.Assert.fail("Expecting exception: ");
        } catch (IllegalArgumentException expectedException__IllegalArgumentException) {
            org.junit.Assert.assertTrue(true);
        }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals((-2.79044034420152E-25), double0, 0.01);
        Assert.assertEquals(0, brentSolver0.getIterationCount());
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals((-8.716389609881157E-9), double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        BrentSolver brentSolver0 = new BrentSolver(((UnivariateRealFunction) (quinticFunction0)));
        double double0 = brentSolver0.solve((-3233.97), 533.57297377);
        Assert.assertEquals(38, brentSolver0.getIterationCount());
        Assert.assertEquals(0.9999998433617939, double0, 0.01);
    }
}
