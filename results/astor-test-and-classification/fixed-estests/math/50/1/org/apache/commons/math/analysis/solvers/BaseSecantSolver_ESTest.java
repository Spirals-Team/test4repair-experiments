...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test00() throws Throwable {
        ...
        Assert.assertEquals((-1953.08857), double0, 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals((-775.7632004743342), regulaFalsiSolver0.getMax(), 0.01);
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals(4686.441224145423, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1593.0615629884098), double0, 0.01);
    }
    ...
    public void test17() throws Throwable {
        ...
        Assert.assertEquals(4.690421218998469E-5, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-2101.725485251572), double0, 0.01);
    }
    ...
    public void test18() throws Throwable {
        ...
        Assert.assertEquals((-2407.991798478), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-2034.181243199275), double0, 0.01);
    }
    ...
    public void test19() throws Throwable {
        ...
        Assert.assertEquals(559.8354325221003, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(3879.7025609974794, double0, 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        Assert.assertEquals(0.027716956358934963, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals((-8.828761848400547E-13), double0, 0.01);
    }
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals((-2009.059827377884), illinoisSolver0.getMin(), 0.01);
        Assert.assertEquals(692.42080224822, double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals((-83.73422102566559), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(4.713961858257261E-10, double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        Assert.assertEquals(0.699999988079071, pegasusSolver0.getStartValue(), 0.01);
    ...
    public void test24() throws Throwable {
        ...
        IllinoisSolver illinoisSolver0 = new IllinoisSolver();
        double double0 = illinoisSolver0.solve(904, ((UnivariateRealFunction) (quinticFunction0)), (-167.84314), 0.3746979486688362, allowedSolution0);
        Assert.assertEquals(0.3746979486688362, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals(4.713961858257261E-10, double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        ...
        double double0 = illinoisSolver0.solve(904, ((UnivariateRealFunction) (quinticFunction0)), (-167.84314), 0.3746979486688362, allowedSolution0);
        Assert.assertEquals(0.3746979486688362, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals((-3.4534521740389826E-19), double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals((-75.17540396227682), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1.2036338180483608E-16, double0, 0.01);
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals((-83.7342210256656), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-167.84314), double0, 0.01);
    }
    ...
    public void test29() throws Throwable {
        try {
            ...
            Assert.assertEquals((-3227.1), regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals(194.77874452256526, double0, 0.01);
    ...
    public void test30() throws Throwable {
        ...
        Assert.assertEquals(0.036058063235607, pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals(2.4424104073682394E14, double0, 0.01);
    }
    ...
    public void test33() throws Throwable {
        ...
        Assert.assertEquals(3828.0, regulaFalsiSolver0.getMax(), 0.01);
    ...
    public void test34() throws Throwable {
        ...
        Assert.assertEquals(2881.0, regulaFalsiSolver0.getMax(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test35() throws Throwable {
        ...
        double double0 = illinoisSolver0.doSolve();
        Assert.assertEquals((-2545.1854), illinoisSolver0.getMin(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
