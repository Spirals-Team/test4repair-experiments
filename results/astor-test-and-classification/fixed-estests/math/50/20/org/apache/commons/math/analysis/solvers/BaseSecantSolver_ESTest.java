...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test00() throws Throwable {
        ...
        Assert.assertEquals((-3410.0405), pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-8.0E298), double0, 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals((-2.543391299118114E-6), illinoisSolver0.getStartValue(), 0.01);
    }
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals((-605.1148479348399), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1.1872446783936203E-9), double0, 0.01);
    }
    ...
    public void test16() throws Throwable {
        ...
        Assert.assertEquals((-219.834644464383), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(793.2521450314227, double0, 0.01);
    }
    ...
    public void test17() throws Throwable {
        try {
            ...
            Assert.assertEquals((-312.330175463), regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals((-359.71235883603134), double0, 0.01);
    ...
    public void test18() throws Throwable {
        ...
        Assert.assertEquals((-402.74135978755), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(397.3185963436734, double0, 0.01);
    }
    ...
    public void test19() throws Throwable {
        ...
        Assert.assertEquals(1756.0097522476206, illinoisSolver0.getStartValue(), 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        Assert.assertEquals((-604.7413592875499), regulaFalsiSolver0.getStartValue(), 0.01);
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals(462.1581764074339, double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals((-604.4999995), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-646.1122787094846), double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        Assert.assertEquals((-605.1148479348399), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1210.229695869679), double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals(1397.1544137514284, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(2789.7342763877364, double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        try {
            ...
            Assert.assertEquals(1397.1736455, regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals(2789.734277328548, double0, 0.01);
            org.junit.Assert.fail("Expecting exception: TooManyEvaluationsException");
        } catch (TooManyEvaluationsException expectedException__TooManyEvaluationsException) {
            org.junit.Assert.assertTrue(true);
        }
    ...
    public void test26() throws Throwable {
        ...
        double double0 = regulaFalsiSolver0.solve(1198, ((UnivariateRealFunction) (sinFunction0)), (-1209.4827195751), 1.0E-6, allowedSolution0);
        Assert.assertEquals((-604.7413592875499), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(4.3840572465310467E-23, double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals(4.0, regulaFalsiSolver0.getMin(), 0.01);
        Assert.assertEquals(2781.879935284031, double0, 0.01);
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals((-10.209356132080046), pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals(4.524906152347724E-27, double0, 0.01);
    }
    ...
    public void test29() throws Throwable {
        ...
        Assert.assertEquals((-0.1666666567325592), pegasusSolver0.getStartValue(), 0.01);
    ...
    public void test32() throws Throwable {
        ...
        Assert.assertEquals(4.890303768410003E-8, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
