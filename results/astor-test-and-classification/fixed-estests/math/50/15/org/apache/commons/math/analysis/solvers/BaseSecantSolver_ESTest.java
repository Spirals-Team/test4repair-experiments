...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test02() throws Throwable {
        ...
        Assert.assertEquals(1783.38413596, pegasusSolver0.getMin(), 0.01);
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals(1613.88834, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals(1657.1, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test17() throws Throwable {
        ...
        Assert.assertEquals(1.8362407942122445, pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals(3194.4035316525205, double0, 0.01);
    }
    ...
    public void test18() throws Throwable {
        ...
        Assert.assertEquals(1.8362407942122445, pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals(2367.2022598233634, double0, 0.01);
    }
    ...
    public void test19() throws Throwable {
        ...
        Assert.assertEquals((-3243.27), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-3221.7029558614945), double0, 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        Assert.assertEquals(3006.611290686417, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-3221.7029558614945), double0, 0.01);
    }
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals((-2125.4), illinoisSolver0.getStartValue(), 0.01);
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals(39.0, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-3240.55251358853), double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        double double0 = pegasusSolver0.doSolve();
        Assert.assertEquals(1184.5192503087878, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(2367.2022598233634, double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals(3006.6112907, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-3221.7029558615213), double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        ...
        Assert.assertEquals((-1058.2824932), pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals((-1058.2824932), double0, 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        Assert.assertEquals((-501.8080957874988), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1002.168056495144), double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        try {
            ...
            Assert.assertEquals(888.0235873, regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals(469.66810171167407, double0, 0.01);
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals(0.7937005259840998, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-804.2477193189872), double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        Assert.assertEquals(893.51799162, illinoisSolver0.getStartValue(), 0.01);
    ...
    public void test31() throws Throwable {
        ...
        Assert.assertEquals(39.0, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-4729.23), double0, 0.01);
    }
    ...
    public void test32() throws Throwable {
        ...
        Assert.assertEquals(2612.0, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-2700.632601382337), double0, 0.01);
    }
