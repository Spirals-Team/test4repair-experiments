...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test02() throws Throwable {
        ...
        Assert.assertEquals((-777.665263), regulaFalsiSolver0.getStartValue(), 0.01);
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals((-1.0), illinoisSolver0.getMin(), 0.01);
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals((-0.08497364845391242), illinoisSolver0.getMin(), 0.01);
    ...
    public void test15() throws Throwable {
        ...
        Assert.assertEquals(4.3775854536800003E8, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(8.75513075767585E8, double0, 0.01);
    }
    ...
    public void test16() throws Throwable {
        ...
        Assert.assertEquals(5.0000001192092896, double0, 0.01);
    }
    ...
    public void test17() throws Throwable {
        ...
        Assert.assertEquals(366.22442558583003, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(4.999999999999943, double0, 0.01);
    }
    ...
    public void test18() throws Throwable {
        ...
        Assert.assertEquals((-5.7477823629900024), pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(5.0000001192092896, double0, 0.01);
    }
    ...
    public void test19() throws Throwable {
        ...
        Assert.assertEquals(2.7553817452272217E-6, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(4.999999999999943, double0, 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        Assert.assertEquals((-563.5819999999999), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(695.8613357032118, double0, 0.01);
    }
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals((-563.5819999999999), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(794.8229413582177, double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals((-2591.8139392115795), double0, 0.01);
    }
    ...
    public void test23() throws Throwable {
        ...
        Assert.assertEquals((-608.256155802178), pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals((-608.256155802178), double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals((-971.4430277627754), pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1932.0794819577227), double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        ...
        Assert.assertEquals(366.22442558583003, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.2510086936800417, double0, 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        AllowedSolution allowedSolution0 = AllowedSolution.ANY_SIDE;
        double double0 = pegasusSolver0.solve(900284936, ((UnivariateRealFunction) (xMinus5Function0)), 0.2510086936800417, 366.22442558583003, 366.22442558583003, allowedSolution0);
        Assert.assertEquals(0.2510086936800417, pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals(5.000000000000057, double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals((-1158.8550958539688), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-21.991060927917275), double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        Assert.assertEquals(1.3776908724949521E-6, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(5.0, double0, 0.01);
    }
    ...
    public void test31() throws Throwable {
        ...
        double double0 = illinoisSolver0.doSolve();
        Assert.assertEquals(19.0, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
