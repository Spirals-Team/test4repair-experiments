...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test02() throws Throwable {
        ...
        Assert.assertEquals((-273.98254), pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-583.6434291045396), double0, 0.01);
    }
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals(2097.0, pegasusSolver0.getStartValue(), 0.01);
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals((-1504.175), pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test07() throws Throwable {
        ...
        Assert.assertEquals(695.2256595431662, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(374.2265331405148, double0, 0.01);
    }
    ...
    public void test08() throws Throwable {
        ...
        double double0 = pegasusSolver0.doSolve();
        Assert.assertEquals(2097.0, pegasusSolver0.getMin(), 0.01);
        Assert.assertEquals((-1370.43171), double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals(991.5075, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(857.6547944300135, double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals(991.7435125995527, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(742.0, double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        ...
        double double0 = illinoisSolver0.solve(742, ((UnivariateRealFunction) (sinFunction0)), ((double) (742)), 1241.015, allowedSolution0);
        Assert.assertEquals(991.5075, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1173.8325059886802, double0, 0.01);
    }
    ...
    public void test26() throws Throwable {
        ...
        Assert.assertEquals((-428.5499995), regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(7.335775329831233E-26, double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals(1296.0550005000002, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1950.929037815978, double0, 0.01);
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals(1241.015, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1.0512481240620044E-18, double0, 0.01);
    }
    ...
    public void test29() throws Throwable {
        ...
        Assert.assertEquals(1026.9640237067142, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(1311.9280474134287, double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        double double0 = illinoisSolver0.solve(742, ((UnivariateRealFunction) (sinFunction0)), (-2369.5674973), 0.99, 1241.015, allowedSolution0);
        Assert.assertEquals(1241.015, illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1.5209977784907697E-9), double0, 0.01);
    }
    ...
    public void test31() throws Throwable {
        ...
        Assert.assertEquals(1241.015, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals(1173.8325059886802, double0, 0.01);
    }
    ...
    public void test32() throws Throwable {
        try {
            ...
            Assert.assertEquals(1296.182605387058, regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals(3.14159330889868, double0, 0.01);
    ...
    public void test33() throws Throwable {
        ...
        Assert.assertEquals(5.368709120000005E8, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(3.1415926535902448, double0, 0.01);
    }
    ...
    public void test34() throws Throwable {
        ...
        Assert.assertEquals(4.8892201607E8, illinoisSolver0.getStartValue(), 0.01);
    ...
    public void test35() throws Throwable {
        ...
        Assert.assertEquals(742.0, illinoisSolver0.getMin(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test36() throws Throwable {
        ...
        Assert.assertEquals(313.9, pegasusSolver0.getStartValue(), 0.01);
    ...
    public void test37() throws Throwable {
        ...
        Assert.assertEquals(849.0, illinoisSolver0.getMin(), 0.01);
        Assert.assertEquals(970.7521299592462, double0, 0.01);
    }
