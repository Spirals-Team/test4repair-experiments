...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
    ...
    public void test03() throws Throwable {
        ...
        Assert.assertEquals((-231.7797033752), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(4.348722948461875E-12, double0, 0.01);
    }
    ...
    public void test04() throws Throwable {
        ...
        Assert.assertEquals(2975.4156879, pegasusSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-2049.0), double0, 0.01);
    }
    ...
    public void test05() throws Throwable {
        ...
        Assert.assertEquals((-195.7779585915), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test18() throws Throwable {
        ...
        Assert.assertEquals((-195.7779585915), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-391.1282853719292), double0, 0.01);
    }
    ...
    public void test19() throws Throwable {
        ...
        double double0 = illinoisSolver0.solve(834, univariateRealFunction0, (-391.555917183), 0.0, allowedSolution0);
        Assert.assertEquals((-195.7779585915), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-391.1282853719293), double0, 0.01);
    }
    ...
    public void test20() throws Throwable {
        ...
        Assert.assertEquals(0.7431748490970475, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals((-372.2787294503905), double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals(822.0, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals(300.02209841782525, double0, 0.01);
    }
    ...
    public void test24() throws Throwable {
        ...
        Assert.assertEquals((-196.4518740920823), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-58.11946409141227), double0, 0.01);
    }
    ...
    public void test25() throws Throwable {
        ...
        Assert.assertEquals((-296.8805057642354), double0, 0.01);
    ...
    public void test26() throws Throwable {
        ...
        Assert.assertEquals(3765.458786, regulaFalsiSolver0.getMax(), 0.01);
        Assert.assertEquals(2412.7431579569616, double0, 0.01);
    }
    ...
    public void test27() throws Throwable {
        ...
        Assert.assertEquals((-1.4361469323153866), illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals((-1.5707963267948968), double0, 0.01);
    }
    ...
    public void test28() throws Throwable {
        ...
        Assert.assertEquals((-1.436147), illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals((-361.2831551628262), double0, 0.01);
    }
    ...
    public void test29() throws Throwable {
        ...
        AllowedSolution allowedSolution0 = AllowedSolution.LEFT_SIDE;
        double double0 = illinoisSolver0.solve(822, univariateRealFunction0, (-391.555917183), (-1.4361469323153866), allowedSolution0);
        Assert.assertEquals((-196.49603205765771), illinoisSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-1.5707963267948968), double0, 0.01);
    }
    ...
    public void test30() throws Throwable {
        ...
        Assert.assertEquals(0.12486410089472413, regulaFalsiSolver0.getStartValue(), 0.01);
        Assert.assertEquals(435.1082842477671, double0, 0.01);
    }
    ...
    public void test31() throws Throwable {
        try {
            ...
            Assert.assertEquals((-325.81387665942407), regulaFalsiSolver0.getStartValue(), 0.01);
            Assert.assertEquals((-650.3096792930846), double0, 0.01);
    ...
    public void test32() throws Throwable {
        ...
        double double0 = illinoisSolver0.doSolve();
        Assert.assertEquals((-1244.8406823), illinoisSolver0.getStartValue(), 0.01);
    ...
    public void test34() throws Throwable {
        ...
        double double0 = illinoisSolver0.doSolve();
        Assert.assertEquals(443.45315609632615, illinoisSolver0.getMax(), 0.01);
        Assert.assertEquals((-926.9), double0, 0.01);
    }
    ...
    public void test35() throws Throwable {
        ...
        Assert.assertEquals((-525.258092424), illinoisSolver0.getMin(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
    }
