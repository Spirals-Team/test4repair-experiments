...
public class Complex_ESTest extends Complex_ESTest_scaffolding {
    ...
    public void test001() throws Throwable {
        ...
        Assert.assertEquals((-3820.8419198180536), complex0.getImaginary(), 0.01);
        Assert.assertEquals((-43.70836258553993), complex1.getImaginary(), 0.01);
        Assert.assertEquals(43.70836258553993, complex1.getReal(), 0.01);
    }
    ...
    public void test002() throws Throwable {
        ...
        Assert.assertEquals(2.1377093678760284, complex2.getImaginary(), 0.01);
        Assert.assertEquals(1.203092576144877, complex2.getReal(), 0.01);
    }
    ...
    public void test003() throws Throwable {
        ...
        Assert.assertEquals(2599.01547177, complex1.getImaginary(), 0.01);
    ...
    public void test004() throws Throwable {
        ...
        Assert.assertFalse(boolean0);
        Assert.assertEquals(4462606.273269387, complex0.getImaginary(), 0.01);
    ...
    public void test005() throws Throwable {
        ...
        Assert.assertEquals(917.59, complex0.getImaginary(), 0.01);
    }
    ...
    public void test006() throws Throwable {
        ...
        Assert.assertEquals(0.003206967505418994, complex1.getImaginary(), 0.01);
    ...
    public void test007() throws Throwable {
        ...
        Assert.assertEquals((-6.632281154677804E-21), complex2.getImaginary(), 0.01);
        Assert.assertEquals(5.604948205905064, complex1.getReal(), 0.01);
        Assert.assertEquals(0.9999729212906231, complex2.getReal(), 0.01);
    ...
    public void test008() throws Throwable {
        ...
        Assert.assertEquals(0.0, complex1.getImaginary(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
        Assert.assertEquals((-1.3097208423944078), complex1.getReal(), 0.01);
        Assert.assertEquals((-1876.449511677147), complex0.getReal(), 0.01);
    }
    ...
    public void test010() throws Throwable {
        ...
        Assert.assertEquals(1.0, complex1.getReal(), 0.01);
        Assert.assertTrue(complex3.equals(((Object) (complex0))));
    ...
    public void test013() throws Throwable {
        ...
        Complex complex1 = complex0.sqrt();
        Assert.assertEquals((-758.368235457835), complex0.getImaginary(), 0.01);
        Assert.assertEquals(12.532485954502164, complex1.getReal(), 0.01);
        Assert.assertEquals((-30.256097561609444), complex1.getImaginary(), 0.01);
    }
    ...
    public void test014() throws Throwable {
        ...
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals((-419.0), complex0.getImaginary(), 0.01);
        Assert.assertEquals(Double.POSITIVE_INFINITY, complex1.getImaginary(), 0.01);
        Assert.assertTrue(complex1.isInfinite());
        Assert.assertEquals(Double.POSITIVE_INFINITY, complex1.getReal(), 0.01);
        Assert.assertEquals((-3902.0), complex0.getReal(), 0.01);
    }
    ...
    public void test015() throws Throwable {
        ...
        Assert.assertEquals(Double.NEGATIVE_INFINITY, complex1.getReal(), 0.01);
        Assert.assertEquals((-2298.292888007985), complex0.getReal(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
    }
    ...
    public void test017() throws Throwable {
        ...
        Complex complex1 = complex0.sinh();
        Assert.assertFalse(complex1.isInfinite());
        Assert.assertEquals(311.82212682898, complex0.getImaginary(), 0.01);
        Assert.assertEquals((-0.7204521825485775), complex1.getImaginary(), 0.01);
        Assert.assertEquals((-0.0), complex1.getReal(), 0.01);
    }
    ...
    public void test019() throws Throwable {
        ...
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals(0.0, complex2.getImaginary(), 0.01);
        Assert.assertEquals((-1877.244323532096), complex2.getReal(), 0.01);
    }
    ...
    public void test020() throws Throwable {
        ...
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals((-419.0), complex0.getImaginary(), 0.01);
        Assert.assertEquals((-6.591064495622037E180), complex1.getReal(), 0.01);
        Assert.assertEquals((-4.612849365254901E181), complex1.getImaginary(), 0.01);
    }
    ...
    public void test024() throws Throwable {
        ...
        Complex complex1 = complex0.negate();
        Assert.assertEquals((-1021.53811274), complex1.getReal(), 0.01);
        Assert.assertEquals(1021.53811274, complex0.getImaginary(), 0.01);
        Assert.assertEquals(1021.53811274, complex0.getReal(), 0.01);
        Assert.assertEquals((-1021.53811274), complex1.getImaginary(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
    }
    ...
    public void test025() throws Throwable {
        ...
        Assert.assertEquals((-853.7838782144594), complex2.getImaginary(), 0.01);
        Assert.assertEquals((-1523.244718235723), complex2.getReal(), 0.01);
        Assert.assertEquals(3.141592653589793, complex1.getImaginary(), 0.01);
        Assert.assertEquals(5.604948205905064, complex1.getReal(), 0.01);
    }
    ...
    public void test026() throws Throwable {
        ...
        Assert.assertEquals(0.0, complex2.getReal(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
        Assert.assertEquals((-1150244.7611028606), complex2.getImaginary(), 0.01);
    }
    ...
    public void test027() throws Throwable {
        ...
        Assert.assertEquals(591.7186446498398, complex0.getImaginary(), 0.01);
        Assert.assertEquals((-1168528.6640819944), complex1.getImaginary(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
        Assert.assertEquals(1545.51319, complex0.getReal(), 0.01);
        Assert.assertEquals((-3052086.4596053427), complex1.getReal(), 0.01);
    }
    ...
    public void test030() throws Throwable {
        ...
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals((-0.0), complex1.getImaginary(), 0.01);
        Assert.assertEquals((-1493.754711), complex0.getReal(), 0.01);
        Assert.assertEquals((-1493.754711), complex0.getImaginary(), 0.01);
    ...
    public void test032() throws Throwable {
        ...
        Assert.assertEquals(917.59, complex0.getImaginary(), 0.01);
        Assert.assertEquals(0.008336750013465571, double0, 0.01);
        Assert.assertFalse(complex0.isInfinite());
    ...
    public void test033() throws Throwable {
        Complex complex0 = new Complex((-1808.0165719), (-1808.0165719));
        double double0 = complex0.getReal();
        Assert.assertEquals((-1808.0165719), complex0.getImaginary(), 0.01);
        Assert.assertEquals((-1808.0165719), double0, 0.01);
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertFalse(complex0.isNaN());
    }
    ...
    public void test039() throws Throwable {
        ...
        Assert.assertEquals(20.680219672661934, complex2.getImaginary(), 0.01);
        Assert.assertEquals((-271.7678491), complex0.getReal(), 0.01);
        Assert.assertEquals(3.141592653589793, complex1.getImaginary(), 0.01);
    }
    ...
    public void test041() throws Throwable {
        ...
        Assert.assertEquals(0.0, complex1.getImaginary(), 0.01);
        Assert.assertEquals((-1827.53383), complex1.getReal(), 0.01);
    }
    ...
    public void test044() throws Throwable {
        ...
        Assert.assertEquals((-0.0), complex1.getImaginary(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
        Assert.assertEquals((-1876.449511677147), complex1.getReal(), 0.01);
    }
    ...
    public void test045() throws Throwable {
        Complex complex0 = new Complex((-758.368235457835), (-758.368235457835));
        Complex complex1 = complex0.atan();
        Assert.assertEquals((-1.5701370162891042), complex1.getReal(), 0.01);
        Assert.assertEquals((-6.593101236648327E-4), complex1.getImaginary(), 0.01);
    }
    ...
    public void test047() throws Throwable {
        Complex complex0 = new Complex((-1808.0165719), (-1808.0165719));
        Complex complex1 = complex0.asin();
        Assert.assertEquals((-0.7853981251585651), complex1.getReal(), 0.01);
        Assert.assertEquals((-8.539706477623929), complex1.getImaginary(), 0.01);
    }
    ...
    public void test053() throws Throwable {
        ...
        Assert.assertEquals(1.5707963267948966, complex1.getReal(), 0.01);
        Assert.assertEquals((-6.211888414325436), complex1.getImaginary(), 0.01);
    }
    ...
    public void test059() throws Throwable {
        ...
        Assert.assertEquals(734.86754611658, complex0.getImaginary(), 0.01);
        Assert.assertEquals(Double.NEGATIVE_INFINITY, complex1.getReal(), 0.01);
        Assert.assertTrue(complex1.isInfinite());
        Assert.assertEquals(Double.NEGATIVE_INFINITY, complex2.getImaginary(), 0.01);
        Assert.assertEquals(Double.NaN, complex3.getReal(), 0.01);
    ...
    public void test063() throws Throwable {
        ...
        Complex complex1 = complex0.multiply(complex0);
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals(3521062.7698734035, complex1.getReal(), 0.01);
        Assert.assertEquals(0.0, complex0.getImaginary(), 0.01);
        Assert.assertEquals((-0.0), complex1.getImaginary(), 0.01);
    }
    ...
    public void test067() throws Throwable {
        ...
        Assert.assertEquals(2553.049476128916, double0, 0.01);
    }
    ...
    public void test068() throws Throwable {
        Complex complex0 = new Complex((-1808.0165719), (-1808.0165719));
        double double0 = complex0.abs();
        Assert.assertEquals(2556.92155697629, double0, 0.01);
        Assert.assertEquals((-1808.0165719), complex0.getReal(), 0.01);
        Assert.assertEquals((-1808.0165719), complex0.getImaginary(), 0.01);
    }
    ...
    public void test069() throws Throwable {
        ...
        Assert.assertTrue(complex1.isInfinite());
        Assert.assertEquals(2412.4767075, complex1.getImaginary(), 0.01);
        Assert.assertTrue(complex0.isInfinite());
        Assert.assertEquals(Double.POSITIVE_INFINITY, complex1.getReal(), 0.01);
    }
    ...
    public void test071() throws Throwable {
        ...
        Assert.assertEquals(17.0, complex0.getReal(), 0.01);
    }
    ...
    public void test073() throws Throwable {
        ...
        Assert.assertEquals((-1672.761847534807), double0, 0.01);
    ...
    public void test074() throws Throwable {
        ...
        double double0 = complex0.getReal();
        Assert.assertEquals(427.8409995891, complex0.getImaginary(), 0.01);
        Assert.assertEquals(0.0, double0, 0.01);
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertFalse(complex0.isNaN());
    }
    ...
    public void test075() throws Throwable {
        ...
        Assert.assertTrue(complex1.isInfinite());
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals((-1876.449511677147), complex0.getImaginary(), 0.01);
    ...
    public void test076() throws Throwable {
        ...
        Assert.assertEquals(1.073741824E9, complex0.getImaginary(), 0.01);
        Assert.assertEquals(Double.NaN, complex1.getImaginary(), 0.01);
        Assert.assertTrue(complex1.isNaN());
        Assert.assertEquals((-0.0), complex1.getReal(), 0.01);
        Assert.assertEquals(1.073741824E9, complex0.getReal(), 0.01);
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals(1, list0.size());
    }
    ...
    public void test078() throws Throwable {
        ...
        Assert.assertEquals(427.8409995891, complex0.getImaginary(), 0.01);
        Assert.assertEquals(33, list0.size());
    }
    ...
    public void test079() throws Throwable {
        ...
        Assert.assertEquals((-2233.3382060759127), complex0.getReal(), 0.01);
        Assert.assertTrue(complex1.isNaN());
        Assert.assertEquals(0.0, complex1.getImaginary(), 0.01);
        Assert.assertTrue(complex2.isNaN());
        Assert.assertFalse(complex0.isInfinite());
    ...
    public void test080() throws Throwable {
        ...
        Assert.assertEquals(Double.POSITIVE_INFINITY, complex1.getReal(), 0.01);
        Assert.assertTrue(complex1.isInfinite());
        Assert.assertEquals((-3342.80857433), complex0.getImaginary(), 0.01);
    ...
    public void test082() throws Throwable {
        ...
        Assert.assertEquals(0.03418564686152713, complex2.getReal(), 0.01);
        Assert.assertEquals(14.626021324835746, complex1.getImaginary(), 0.01);
        Assert.assertEquals((-0.03418564686152713), complex2.getImaginary(), 0.01);
    }
    ...
    public void test087() throws Throwable {
        ...
        Assert.assertEquals(427.8409995891, complex0.getImaginary(), 0.01);
        Assert.assertEquals(0.0, complex1.getImaginary(), 0.01);
        Assert.assertEquals(0.8340439721464672, complex1.getReal(), 0.01);
        Assert.assertFalse(complex1.isInfinite());
    }
    ...
    public void test096() throws Throwable {
        ...
        Assert.assertTrue(complex3.isInfinite());
        Assert.assertEquals(0.7853981633974483, complex3.getImaginary(), 0.01);
    ...
    public void test099() throws Throwable {
        ...
        Assert.assertEquals(427.8409995891, complex0.getImaginary(), 0.01);
        Assert.assertEquals(0.0, complex0.getReal(), 0.01);
        Assert.assertEquals((-50939.005621675984), complex1.getImaginary(), 0.01);
        Assert.assertEquals((-0.0), complex1.getReal(), 0.01);
    }
    ...
    public void test104() throws Throwable {
        ...
        complex0.hashCode();
        Assert.assertFalse(complex0.isNaN());
        Assert.assertEquals((-758.368235457835), complex0.getReal(), 0.01);
        Assert.assertEquals((-758.368235457835), complex0.getImaginary(), 0.01);
        Assert.assertFalse(complex0.isInfinite());
    }
    ...
    public void test105() throws Throwable {
        ...
        Complex complex2 = complex1.tan();
        boolean boolean0 = complex2.equals(complex1);
        Assert.assertEquals((-0.4283734758436346), complex2.getImaginary(), 0.01);
        Assert.assertFalse(complex1.equals(((Object) (complex2))));
        Assert.assertFalse(boolean0);
        Assert.assertEquals(0.0, complex2.getReal(), 0.01);
        Assert.assertFalse(complex2.isInfinite());
        Assert.assertEquals(0.0, complex1.getReal(), 0.01);
        Assert.assertEquals((-0.4579028990391944), complex1.getImaginary(), 0.01);
    }
    ...
    public void test121() throws Throwable {
        Complex complex0 = new Complex(0.0, 427.8409995891);
        Complex complex1 = complex0.pow(complex0);
        Assert.assertEquals((-4.8797323214201825E-293), complex1.getImaginary(), 0.01);
        Assert.assertEquals((-1.2640473360052051E-292), complex1.getReal(), 0.01);
    }
    ...
    public void test122() throws Throwable {
        ...
        Assert.assertFalse(complex0.isInfinite());
        Assert.assertEquals("(-271.7678491, 0.0)", string0);
        Assert.assertFalse(complex0.isNaN());
    }
    ...
    public void test125() throws Throwable {
        ...
        Assert.assertEquals(0.0, complex0.getReal(), 0.01);
        Assert.assertFalse(complex1.isNaN());
        Assert.assertEquals(427.8409995891, complex1.getImaginary(), 0.01);
    }
    ...
    public void test049() throws Throwable {
        ...
        Assert.assertTrue(complex2.isNaN());
        // AssertFixer: old assertion Assert.assertEquals((-1493.754711), complex2.getImaginary(), 0.01)
        Assert.assertEquals(Double.NaN, complex2.getImaginary(), 0.01);
        ...
        Assert.assertEquals(-0.0, complex1.getImaginary(), 0.01);
        // AssertFixer: old assertion Assert.assertEquals((-1493.754711), complex0.getReal(), 0.01)
        Assert.assertEquals(-1493.754711, complex0.getReal(), 0.01);
        // AssertFixer: old assertion Assert.assertEquals((-1493.754711), complex0.getImaginary(), 0.01)
        Assert.assertEquals(-1493.754711, complex0.getImaginary(), 0.01);
    }
}
