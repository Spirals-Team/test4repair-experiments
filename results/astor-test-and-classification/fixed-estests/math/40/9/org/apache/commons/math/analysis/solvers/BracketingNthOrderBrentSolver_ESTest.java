...
public class BracketingNthOrderBrentSolver_ESTest extends BracketingNthOrderBrentSolver_ESTest_scaffolding {
    ...
    public void test09() throws Throwable {
        ...
        Assert.assertEquals(1989, bracketingNthOrderBrentSolver0.getMaximalOrder());
        Assert.assertEquals((-416.2586242526412), double0, 0.01);
    }
    ...
    public void test11() throws Throwable {
        ...
        Assert.assertEquals((-2.2737367544323206E-13), double0, 0.01);
    }
    ...
    public void test12() throws Throwable {
        ...
        Assert.assertEquals((-1.000000007889595), double0, 0.01);
    }
    ...
    public void test13() throws Throwable {
        ...
        Assert.assertEquals(1429.4246573833648, double0, 0.01);
        Assert.assertEquals(2859, bracketingNthOrderBrentSolver0.getMaximalOrder());
    }
    ...
    public void test15() throws Throwable {
        ...
        Assert.assertEquals(1989.0, double0, 0.01);
        Assert.assertEquals(1989, bracketingNthOrderBrentSolver0.getMaximalOrder());
    }
    ...
    public void test21() throws Throwable {
        ...
        Assert.assertEquals(2939, bracketingNthOrderBrentSolver0.getMaximalOrder());
    }
    ...
    public void test24() throws Throwable {
        ...
        AllowedSolution allowedSolution0 = AllowedSolution.ABOVE_SIDE;
        double double0 = bracketingNthOrderBrentSolver0.solve(68, ((UnivariateFunction) (quinticFunction0)), ((double) (-1019)), ((double) (68)), 8.58335624798201E-12, allowedSolution0);
        Assert.assertEquals(8.412825991399586E-12, double0, 0.01);
        Assert.assertEquals(5, bracketingNthOrderBrentSolver0.getMaximalOrder());
    }
    ...
    public void test10() throws Throwable {
        ...
        // AssertFixer: old assertion Assert.assertEquals((-505.79641722795674), double0, 0.01)
        Assert.assertEquals(-505.79641722795674, double0, 0.01);
        double double1 = bracketingNthOrderBrentSolver0.solve(698, ((UnivariateFunction) (sincFunction0)), (-2431.7), 0.0);
        // AssertFixer: old assertion Assert.assertEquals((-1394.8671381938682), double1, 0.01)
        Assert.assertEquals(-1401.1503235010478, double1, 0.01);
    ...
    public void test14() throws Throwable {
        ...
        double double0 = bracketingNthOrderBrentSolver0.doSolve();
        // AssertFixer: old assertion Assert.assertEquals((-354.9999698556468), double0, 0.01)
        Assert.assertEquals(-348.7167845484672, double0, 0.01);
        Assert.assertEquals(2859, bracketingNthOrderBrentSolver0.getMaximalOrder());
    }
}
