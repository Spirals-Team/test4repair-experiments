...
public class BracketingNthOrderBrentSolver_ESTest extends BracketingNthOrderBrentSolver_ESTest_scaffolding {
    ...
    public void test00() throws Throwable {
        ...
        Assert.assertEquals(5.0, bracketingNthOrderBrentSolver0.getStartValue(), 0.01);
    ...
    public void test11() throws Throwable {
        ...
        Assert.assertEquals(1727, bracketingNthOrderBrentSolver0.getMaximalOrder());
        Assert.assertEquals(1517.38925168387, double0, 0.01);
    }
    ...
    public void test13() throws Throwable {
        ...
        Assert.assertEquals(1233.3474952522356, bracketingNthOrderBrentSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-33.30500949552879), double0, 0.01);
    }
    ...
    public void test14() throws Throwable {
        ...
        AllowedSolution allowedSolution0 = AllowedSolution.LEFT_SIDE;
        double double0 = bracketingNthOrderBrentSolver0.solve(2500, ((UnivariateFunction) (sinFunction0)), (-33.30500949552879), ((double) (2500)), allowedSolution0);
        Assert.assertEquals((-33.30500949552879), bracketingNthOrderBrentSolver0.getMin(), 0.01);
        Assert.assertEquals((-33.30500949552879), double0, 0.01);
    }
    ...
    public void test16() throws Throwable {
        ...
        Assert.assertEquals(3.410548263679857, bracketingNthOrderBrentSolver0.getStartValue(), 0.01);
        Assert.assertEquals((-3223.274062583126), double0, 0.01);
    }
    ...
    public void test22() throws Throwable {
        ...
        Assert.assertEquals(0.0, double0, 0.01);
        Assert.assertEquals(3148, bracketingNthOrderBrentSolver0.getMaximalOrder());
    }
    ...
    public void test09() throws Throwable {
        ...
        double double0 = bracketingNthOrderBrentSolver0.doSolve();
        // AssertFixer: old assertion Assert.assertEquals((-2054.601595447725), double0, 0.01)
        Assert.assertEquals(-2111.1502627039345, double0, 0.01);
    }
    ...
    public void test12() throws Throwable {
        ...
        Assert.assertEquals(5, bracketingNthOrderBrentSolver0.getMaximalOrder());
        // AssertFixer: old assertion Assert.assertEquals((-483.80526932132705), double0, 0.01)
        Assert.assertEquals(-471.2388980385281, double0, 0.01);
    }
}
