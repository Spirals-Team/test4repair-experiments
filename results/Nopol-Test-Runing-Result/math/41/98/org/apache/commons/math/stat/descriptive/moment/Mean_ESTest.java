...
public class Mean_ESTest extends org.apache.commons.math.stat.descriptive.moment.Mean_ESTest_scaffolding {
    ...
    public void test00() throws java.lang.Throwable {
        ...
        doubleArray0[1] = 3748.12191461636;
        double[] doubleArray1 = new double[4];
        doubleArray1[1] = 7.549789948768648E-8;
        double double0 = mean0.evaluate(doubleArray0, doubleArray1);
        org.junit.Assert.assertEquals(3748.12191461636, double0, 0.01);
    }
    ...
    public void test03() throws java.lang.Throwable {
        org.apache.commons.math.stat.descriptive.moment.Mean mean0 = new org.apache.commons.math.stat.descriptive.moment.Mean();
        mean0.increment((-2720.538485));
        double double0 = mean0.getResult();
        org.junit.Assert.assertEquals((-2720.538485), double0, 0.01);
    }

    @org.junit.Test(timeout = 4000)
    public void test04() throws java.lang.Throwable {
        org.apache.commons.math.stat.descriptive.moment.Mean mean0 = new org.apache.commons.math.stat.descriptive.moment.Mean();
        mean0.increment((-733.9853));
        long long0 = mean0.getN();
        org.junit.Assert.assertEquals((-733.9853), mean0.getResult(), 0.01);
    ...
    public void test05() throws java.lang.Throwable {
        org.apache.commons.math.stat.descriptive.moment.Mean mean0 = new org.apache.commons.math.stat.descriptive.moment.Mean(((org.apache.commons.math.stat.descriptive.moment.FirstMoment)(null)));
        double[] doubleArray0 = new double[4];
        doubleArray0[0] = -0.8071288759302929;
        double[] doubleArray1 = new double[4];
        doubleArray1[0] = 7.549789948768648E-8;
        double double0 = mean0.evaluate(doubleArray0, doubleArray1);
        org.junit.Assert.assertEquals((-0.8071288759302929), double0, 0.01);
    }
    ...
    public void test06() throws java.lang.Throwable {
        ...
        doubleArray0[1] = -298.824145917763;
        double double0 = mean0.evaluate(doubleArray0, 1, 1);
        org.junit.Assert.assertEquals((-298.824145917763), double0, 0.01);
    }
    ...
    public void test28() throws java.lang.Throwable {
        ...
        doubleArray0[5] = 0.0083;
        double double0 = mean0.evaluate(doubleArray0, doubleArray0, 5, 5);
        org.junit.Assert.assertEquals(0.0083, double0, 0.01);
    }
