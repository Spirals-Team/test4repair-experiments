...
public class Mean_ESTest extends org.apache.commons.math.stat.descriptive.moment.Mean_ESTest_scaffolding {
    ...
    public void test00() throws java.lang.Throwable {
        ...
        doubleArray0[0] = -1723.8980116548296;
        doubleArray0[3] = -1.0;
        double double0 = mean0.evaluate(doubleArray0);
        org.junit.Assert.assertEquals((-191.65533462831436), double0, 0.01);
    }
    ...
    public void test03() throws java.lang.Throwable {
        org.apache.commons.math.stat.descriptive.moment.Mean mean0 = new org.apache.commons.math.stat.descriptive.moment.Mean();
        mean0.increment((-2012.4501541));
        double double0 = mean0.getResult();
        org.junit.Assert.assertEquals(1L, mean0.getN());
        org.junit.Assert.assertEquals((-2012.4501541), double0, 0.01);
    }

    @org.junit.Test(timeout = 4000)
    public void test04() throws java.lang.Throwable {
        org.apache.commons.math.stat.descriptive.moment.Mean mean0 = new org.apache.commons.math.stat.descriptive.moment.Mean();
        mean0.increment((-1723.8980116548296));
    ...
    public void test25() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals(0.38, double0, 0.01);
    }
    ...
    public void test27() throws java.lang.Throwable {
        ...
        mean0.increment((-1723.8980116548296));
        mean0.copy();
        org.junit.Assert.assertEquals((-1723.8980116548296), mean0.getResult(), 0.01);
    }
    ...
    public void test30() throws java.lang.Throwable {
        ...
        doubleArray0[11] = 0.18695805655987402;
        double double0 = mean0.evaluate(doubleArray0, doubleArray0);
        org.junit.Assert.assertEquals(0.18695805655987402, double0, 0.01);
    }
    ...
    public void test35() throws java.lang.Throwable {
        ...
        mean0.increment((-489.9330232552015));
        org.junit.Assert.assertEquals(java.lang.Double.NaN, mean0.getResult(), 0.01);
    }
