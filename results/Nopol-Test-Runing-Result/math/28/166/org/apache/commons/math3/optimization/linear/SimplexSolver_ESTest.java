...
public class SimplexSolver_ESTest extends org.apache.commons.math3.optimization.linear.SimplexSolver_ESTest_scaffolding {
    ...
    public void test0() throws java.lang.Throwable {
        ...
        org.apache.commons.math3.optimization.linear.SimplexTableau simplexTableau0 = new org.apache.commons.math3.optimization.linear.SimplexTableau(linearObjectiveFunction0 , linkedList0 , goalType0 , true , 100 , (-2444));
    ...
    public void test5() throws java.lang.Throwable {
        org.apache.commons.math3.optimization.linear.SimplexSolver simplexSolver0 = new org.apache.commons.math3.optimization.linear.SimplexSolver((-155.66198764) , 0);
        org.junit.Assert.assertEquals(100, simplexSolver0.getMaxIterations());
    }
