...
public class SimplexSolver_ESTest extends org.apache.commons.math3.optimization.linear.SimplexSolver_ESTest_scaffolding {
    ...
    public void test7() throws java.lang.Throwable {
        org.apache.commons.math3.optimization.linear.SimplexSolver simplexSolver0 = new org.apache.commons.math3.optimization.linear.SimplexSolver((-908.83596838) , (-669));
        org.junit.Assert.assertEquals(0, simplexSolver0.getIterations());
    }
}
