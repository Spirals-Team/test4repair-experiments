...
public class BrentSolver_ESTest extends org.apache.commons.math.analysis.solvers.BrentSolver_ESTest_scaffolding {
    ...
    public void test00() throws java.lang.Throwable {
        ...
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(sinFunction0)), 1.0E-15, 1325.71412567);
    ...
    public void test01() throws java.lang.Throwable {
        ...
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)), 1662.0, 4081.4484503118065, 3388.840947931522);
        org.junit.Assert.assertEquals(30, brentSolver0.getIterationCount());
        org.junit.Assert.assertEquals(3850.5792829216853, double0, 0.01);
    }
    ...
    public void test03() throws java.lang.Throwable {
        ...
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(monitoredFunction0)), (-2582.8233016788904), (-1045.0914090337));
        org.junit.Assert.assertEquals(14, monitoredFunction0.getCallsCount());
        org.junit.Assert.assertEquals((-1079.1370764951093), double0, 0.01);
    }
    ...
    public void test05() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals((-120.95131716323037), double0, 0.01);
    }
    ...
    public void test18() throws java.lang.Throwable {
        ...
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)), (-2299.101647710109), 1.0E-15);
        org.junit.Assert.assertEquals(1.0E-15, double0, 0.01);
        org.junit.Assert.assertEquals(0, brentSolver0.getIterationCount());
    }
    ...
    public void test20() throws java.lang.Throwable {
        org.apache.commons.math.analysis.Expm1Function expm1Function0 = new org.apache.commons.math.analysis.Expm1Function();
        org.apache.commons.math.analysis.solvers.BrentSolver brentSolver0 = new org.apache.commons.math.analysis.solvers.BrentSolver();
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)), ((double)(0)), 1664.3736993441603);
        org.junit.Assert.assertEquals(0.0, double0, 0.01);
    }
    ...
    public void test21() throws java.lang.Throwable {
        org.apache.commons.math.analysis.Expm1Function expm1Function0 = new org.apache.commons.math.analysis.Expm1Function();
        org.apache.commons.math.analysis.solvers.BrentSolver brentSolver0 = new org.apache.commons.math.analysis.solvers.BrentSolver(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)));
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)), (-1013.855289237233), 0.0);
        org.junit.Assert.assertEquals(0.0, double0, 0.01);
        org.junit.Assert.assertEquals(0, brentSolver0.getIterationCount());
    }
    ...
    public void test22() throws java.lang.Throwable {
        ...
        org.apache.commons.math.analysis.solvers.BrentSolver brentSolver0 = new org.apache.commons.math.analysis.solvers.BrentSolver(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)));
        brentSolver0.setFunctionValueAccuracy(2485.2);
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)), 1.5, 3.75);
    ...
    public void test24() throws java.lang.Throwable {
        ...
        double double0 = brentSolver0.solve(univariateRealFunction0, (-3091.621361442658), 2485.2, 0.03868194116985044);
        org.junit.Assert.assertEquals(1, brentSolver0.getIterationCount());
        org.junit.Assert.assertEquals(0.03868194116985044, double0, 0.01);
    }
    ...
    public void test25() throws java.lang.Throwable {
        ...
        org.apache.commons.math.analysis.solvers.BrentSolver brentSolver0 = new org.apache.commons.math.analysis.solvers.BrentSolver(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)));
        brentSolver0.setFunctionValueAccuracy(2485.2);
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(expm1Function0)), 1.0E-15, 2485.2, 1.5933121311352272);
        org.junit.Assert.assertEquals(0, brentSolver0.getIterationCount());
        org.junit.Assert.assertEquals(1.5933121311352272, double0, 0.01);
    }
    ...
    public void test27() throws java.lang.Throwable {
        org.apache.commons.math.analysis.solvers.BrentSolver brentSolver0 = new org.apache.commons.math.analysis.solvers.BrentSolver();
        org.apache.commons.math.analysis.QuinticFunction quinticFunction0 = new org.apache.commons.math.analysis.QuinticFunction();
        double double0 = brentSolver0.solve(((org.apache.commons.math.analysis.UnivariateRealFunction)(quinticFunction0)), (-2369.03), 270.3268, (-415.1571509402915));
        org.junit.Assert.assertEquals(25, brentSolver0.getIterationCount());
        org.junit.Assert.assertEquals((-0.9999999836726806), double0, 0.01);
    }
    ...
    public void test28() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals((-1.4392058393585307E-9), double0, 0.01);
    }
}
