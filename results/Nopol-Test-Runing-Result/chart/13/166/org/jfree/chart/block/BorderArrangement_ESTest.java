...
public class BorderArrangement_ESTest extends org.jfree.chart.block.BorderArrangement_ESTest_scaffolding {
    ...
    public void test01() throws java.lang.Throwable {
        ...
        org.jfree.data.Range range0 = new org.jfree.data.Range((-2.147483648E9) , (-2.147483648E9));
    ...
    public void test02() throws java.lang.Throwable {
        org.jfree.chart.block.BorderArrangement borderArrangement0 = new org.jfree.chart.block.BorderArrangement();
        org.jfree.chart.block.BlockContainer blockContainer0 = new org.jfree.chart.block.BlockContainer();
        org.jfree.chart.util.RectangleInsets rectangleInsets0 = new org.jfree.chart.util.RectangleInsets(0.0 , 0.0 , 452.7 , 0.0);
        ...
        org.junit.Assert.assertEquals(452.7, size2D0.height, 0.01);
    }
    ...
    public void test03() throws java.lang.Throwable {
        ...
        org.jfree.chart.util.RectangleInsets rectangleInsets0 = new org.jfree.chart.util.RectangleInsets(unitType0 , (-979.99715629) , 0.0 , 246.0879574 , 992.40865534884);
        ...
        borderArrangement0.add(blockContainer0, rectangleEdge0);
        org.jfree.chart.util.Size2D size2D0 = borderArrangement0.arrangeNN(blockContainer0, ((java.awt.Graphics2D)(null)));
        org.junit.Assert.assertEquals((-733.90919889), size2D0.height, 0.01);
        org.junit.Assert.assertEquals(992.40865534884, size2D0.width, 0.01);
    }
    ...
    public void test19() throws java.lang.Throwable {
        ...
        org.jfree.chart.util.RectangleEdge rectangleEdge0 = org.jfree.chart.util.RectangleEdge.BOTTOM;
        borderArrangement0.add(blockContainer0, rectangleEdge0);
        org.jfree.data.Range range0 = new org.jfree.data.Range(0.0 , 1530.250083);
        org.jfree.chart.util.Size2D size2D0 = borderArrangement0.arrangeRR(blockContainer0, range0, range0, ((java.awt.Graphics2D)(null)));
        org.junit.Assert.assertEquals(0.0, size2D0.getHeight(), 0.01);
    }
    ...
    public void test22() throws java.lang.Throwable {
        ...
        org.jfree.chart.util.RectangleInsets rectangleInsets0 = new org.jfree.chart.util.RectangleInsets(unitType0 , 0.5 , 0.5 , 0.5 , 0.5);
        blockContainer0.setMargin(rectangleInsets0);
        org.jfree.chart.util.RectangleEdge rectangleEdge0 = org.jfree.chart.util.RectangleEdge.BOTTOM;
        borderArrangement0.add(blockContainer0, rectangleEdge0);
        org.jfree.chart.util.Size2D size2D0 = borderArrangement0.arrangeFN(blockContainer0, ((java.awt.Graphics2D)(null)), 2.0);
        org.junit.Assert.assertEquals(java.lang.Double.POSITIVE_INFINITY, size2D0.width, 0.01);
    }
    ...
    public void test27() throws java.lang.Throwable {
        ...
        org.jfree.chart.util.RectangleEdge rectangleEdge0 = org.jfree.chart.util.RectangleEdge.TOP;
        borderArrangement0.add(blockContainer0, rectangleEdge0);
        org.jfree.chart.util.Size2D size2D0 = borderArrangement0.arrangeFN(blockContainer0, ((java.awt.Graphics2D)(null)), 2345.9466);
        org.junit.Assert.assertEquals(2345.9466, size2D0.width, 0.01);
    }
    ...
    public void test28() throws java.lang.Throwable {
        ...
        org.jfree.chart.block.BlockContainer blockContainer0 = new org.jfree.chart.block.BlockContainer();
        borderArrangement0.add(blockContainer0, ((java.lang.Object)(null)));
        org.jfree.chart.util.Size2D size2D0 = borderArrangement0.arrangeFN(blockContainer0, ((java.awt.Graphics2D)(null)), 2754.6096814053813);
        org.junit.Assert.assertEquals(2754.6096814053813, size2D0.width, 0.01);
    }
