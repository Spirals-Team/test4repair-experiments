...
public class StatisticalBarRenderer_ESTest extends org.jfree.chart.renderer.category.StatisticalBarRenderer_ESTest_scaffolding {
    ...
    public void test08() throws java.lang.Throwable {
        ...
        statisticalBarRenderer0.setGradientPaintTransformer(((org.jfree.chart.util.GradientPaintTransformer)(null)));
        boolean boolean0 = statisticalBarRenderer0.equals(statisticalBarRenderer1);
    ...
    public void test09() throws java.lang.Throwable {
        ...
        org.jfree.chart.axis.SubCategoryAxis subCategoryAxis0 = new org.jfree.chart.axis.SubCategoryAxis("Point2D.Double[200000.0, 200000.0]");
        org.jfree.data.statistics.DefaultStatisticalCategoryDataset defaultStatisticalCategoryDataset0 = new org.jfree.data.statistics.DefaultStatisticalCategoryDataset();
        try {
            statisticalBarRenderer0.drawVerticalItem(((java.awt.Graphics2D)(null)), categoryStepRenderer_State0, rectangle2D_Double0, combinedRangeCategoryPlot0, subCategoryAxis0, dateAxis0, defaultStatisticalCategoryDataset0, (-1524), 0);
    ...
    public void test13() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals(0.2, statisticalBarRenderer0.getItemMargin(), 0.01);
    }
