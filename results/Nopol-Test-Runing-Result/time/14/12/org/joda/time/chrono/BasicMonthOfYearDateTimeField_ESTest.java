...
public class BasicMonthOfYearDateTimeField_ESTest extends org.joda.time.chrono.BasicMonthOfYearDateTimeField_ESTest_scaffolding {
    ...
    public void test09() throws java.lang.Throwable {
        ...
        try {
            gJMonthOfYearDateTimeField0.add(((org.joda.time.ReadablePartial)(localTime0)), 1, intArray0, 1);
        } catch (java.lang.IllegalAccessError e) {
            org.evosuite.runtime.EvoAssertions.verifyException("org.joda.time.chrono.BasicMonthOfYearDateTimeField", e);
        }
    }
    ...
    public void test10() throws java.lang.Throwable {
        ...
        try {
            gJMonthOfYearDateTimeField0.add(((org.joda.time.ReadablePartial)(partial0)), 13, ((int[])(null)), (-1153));
        } catch (java.lang.IllegalAccessError e) {
            org.evosuite.runtime.EvoAssertions.verifyException("org.joda.time.chrono.BasicMonthOfYearDateTimeField", e);
        }
    }
    ...
    public void test11() throws java.lang.Throwable {
        org.joda.time.chrono.CopticChronology copticChronology0 = org.joda.time.chrono.CopticChronology.getInstance();
        org.joda.time.chrono.GJMonthOfYearDateTimeField gJMonthOfYearDateTimeField0 = new org.joda.time.chrono.GJMonthOfYearDateTimeField(copticChronology0);
        org.joda.time.DateMidnight dateMidnight0 = new org.joda.time.DateMidnight((-3053L) , ((org.joda.time.Chronology)(copticChronology0)));
        org.joda.time.LocalDate localDate0 = dateMidnight0.toLocalDate();
        int[] intArray0 = gJMonthOfYearDateTimeField0.add(((org.joda.time.ReadablePartial)(localDate0)), (-1041), ((int[])(null)), 0);
    ...
    public void test14() throws java.lang.Throwable {
        org.joda.time.tz.FixedDateTimeZone fixedDateTimeZone0 = ((org.joda.time.tz.FixedDateTimeZone)(org.joda.time.DateTimeZone.forOffsetHours(0)));
        org.joda.time.chrono.CopticChronology copticChronology0 = org.joda.time.chrono.CopticChronology.getInstance(((org.joda.time.DateTimeZone)(fixedDateTimeZone0)));
        org.joda.time.chrono.BasicMonthOfYearDateTimeField basicMonthOfYearDateTimeField0 = new org.joda.time.chrono.BasicMonthOfYearDateTimeField(copticChronology0 , (-547));
        try {
    ...
    public void test18() throws java.lang.Throwable {
        org.joda.time.chrono.GregorianChronology gregorianChronology0 = org.joda.time.chrono.GregorianChronology.getInstance();
        org.joda.time.chrono.BasicMonthOfYearDateTimeField basicMonthOfYearDateTimeField0 = new org.joda.time.chrono.BasicMonthOfYearDateTimeField(gregorianChronology0 , 3426);
    ...
    public void test23() throws java.lang.Throwable {
        ...
        org.joda.time.chrono.BasicMonthOfYearDateTimeField basicMonthOfYearDateTimeField0 = new org.joda.time.chrono.BasicMonthOfYearDateTimeField(julianChronology0 , 67);
        try {
