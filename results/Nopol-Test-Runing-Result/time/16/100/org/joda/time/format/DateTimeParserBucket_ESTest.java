...
public class DateTimeParserBucket_ESTest extends org.joda.time.format.DateTimeParserBucket_ESTest_scaffolding {
    ...
    public void test00() throws java.lang.Throwable {
        ...
        org.joda.time.field.SkipUndoDateTimeField skipUndoDateTimeField0 = new org.joda.time.field.SkipUndoDateTimeField(((org.joda.time.Chronology)(ethiopicChronology0)) , dateTimeField0 , 1);
    ...
    public void test04() throws java.lang.Throwable {
        ...
        java.util.Locale locale0 = new java.util.Locale(";m3" , "");
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(2343L , ((org.joda.time.Chronology)(ethiopicChronology0)) , locale0);
    ...
    public void test05() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(((long)(0)) , ((org.joda.time.Chronology)(buddhistChronology0)) , locale0 , ((java.lang.Integer)(1)) , 376);
        java.lang.Integer integer0 = dateTimeParserBucket0.getPivotYear();
    ...
    public void test06() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-1L) , ((org.joda.time.Chronology)(iSOChronology0)) , ((java.util.Locale)(null)) , integer0 , 0);
    ...
    public void test07() throws java.lang.Throwable {
        ...
        java.lang.Integer integer0 = new java.lang.Integer((-12));
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-1645L) , ((org.joda.time.Chronology)(gregorianChronology0)) , locale0 , integer0);
        java.lang.Integer integer1 = dateTimeParserBucket0.getPivotYear();
        org.junit.Assert.assertEquals((-12), ((int)(integer1)));
    }
    ...
    public void test08() throws java.lang.Throwable {
        ...
        java.lang.Integer integer0 = new java.lang.Integer((-3305));
        dateTimeParserBucket0.setOffset(integer0);
        java.lang.Integer integer1 = dateTimeParserBucket0.getOffsetInteger();
        org.junit.Assert.assertEquals((-3305), ((int)(integer1)));
    }

    @org.junit.Test(timeout = 4000)
    public void test09() throws java.lang.Throwable {
        java.util.Locale locale0 = java.util.Locale.KOREAN;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-137L) , ((org.joda.time.Chronology)(null)) , locale0);
    ...
    public void test11() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals((-3305), int0);
    }
    ...
    public void test14() throws java.lang.Throwable {
        org.joda.time.Instant instant0 = new org.joda.time.Instant(1561L);
        org.joda.time.chrono.ISOChronology iSOChronology0 = ((org.joda.time.chrono.ISOChronology)(instant0.getChronology()));
        java.util.Locale locale0 = java.util.Locale.CHINESE;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(1L , ((org.joda.time.Chronology)(iSOChronology0)) , locale0 , ((java.lang.Integer)(null)) , 0);
    ...
    public void test16() throws java.lang.Throwable {
        ...
        org.joda.time.tz.FixedDateTimeZone fixedDateTimeZone0 = ((org.joda.time.tz.FixedDateTimeZone)(org.joda.time.DateTimeZone.forOffsetMillis((-1644))));
        ...
        long long0 = dateTimeParserBucket0.computeMillis();
        org.junit.Assert.assertEquals(1644L, long0);
    }
    ...
    public void test26() throws java.lang.Throwable {
        ...
        java.util.Locale locale0 = java.util.Locale.US;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-2009L) , ((org.joda.time.Chronology)(gJChronology0)) , locale0);
    ...
    public void test28() throws java.lang.Throwable {
        ...
        org.joda.time.field.PreciseDurationField preciseDurationField0 = new org.joda.time.field.PreciseDurationField(durationFieldType0 , 10000000000000000L);
    ...
    public void test31() throws java.lang.Throwable {
        org.joda.time.chrono.BuddhistChronology buddhistChronology0 = org.joda.time.chrono.BuddhistChronology.getInstance();
        java.util.Locale locale0 = java.util.Locale.US;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(3154L , ((org.joda.time.Chronology)(buddhistChronology0)) , locale0 , ((java.lang.Integer)(buddhistChronology0.BE)) , 12);
        dateTimeParserBucket0.setOffset(((java.lang.Integer)(1)));
        long long0 = dateTimeParserBucket0.computeMillis(true, "oZreFn.T\"");
        org.junit.Assert.assertEquals(3153L, long0);
    }
    ...
    public void test33() throws java.lang.Throwable {
        ...
        long long0 = dateTimeParserBucket0.computeMillis(true, "oZreFn.T\"");
        org.junit.Assert.assertEquals((-79271395761000L), long0);
    }
    ...
    public void test34() throws java.lang.Throwable {
        ...
        dateTimeParserBucket0.saveField(dateTimeFieldType0, "", ((java.util.Locale)(null)));
    ...
    public void test35() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-137L) , ((org.joda.time.Chronology)(null)) , locale0);
        org.joda.time.format.DateTimeParserBucket.SavedState dateTimeParserBucket_SavedState0 = dateTimeParserBucket0.new SavedState();
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket1 = new org.joda.time.format.DateTimeParserBucket((-137L) , ((org.joda.time.Chronology)(null)) , locale0 , ((java.lang.Integer)(null)));
    ...
    public void test38() throws java.lang.Throwable {
        java.util.Locale locale0 = java.util.Locale.SIMPLIFIED_CHINESE;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(176L , ((org.joda.time.Chronology)(null)) , locale0);
        dateTimeParserBucket0.setOffset(1);
        int int0 = dateTimeParserBucket0.getOffset();
        org.junit.Assert.assertEquals(1, int0);
    }
    ...
    public void test40() throws java.lang.Throwable {
        ...
        java.lang.Integer integer0 = new java.lang.Integer(2501);
        ...
        dateTimeParserBucket0.setOffset(integer0);
        java.lang.Integer integer1 = dateTimeParserBucket0.getOffsetInteger();
        org.junit.Assert.assertEquals(2501, ((int)(integer1)));
    }
