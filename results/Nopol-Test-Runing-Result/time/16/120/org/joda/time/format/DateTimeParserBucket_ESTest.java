...
public class DateTimeParserBucket_ESTest extends org.joda.time.format.DateTimeParserBucket_ESTest_scaffolding {
    ...
    public void test05() throws java.lang.Throwable {
        ...
        org.joda.time.DateTime dateTime0 = new org.joda.time.DateTime(0L , ((org.joda.time.DateTimeZone)(fixedDateTimeZone0)));
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(1870L , ((org.joda.time.Chronology)(lenientChronology0)) , locale0 , integer0 , 0);
    ...
    public void test06() throws java.lang.Throwable {
        ...
        java.lang.Integer integer0 = new java.lang.Integer((-516));
        dateTimeParserBucket0.setPivotYear(integer0);
        java.lang.Integer integer1 = dateTimeParserBucket0.getPivotYear();
        org.junit.Assert.assertEquals((-516), ((int)(integer1)));
    }

    @org.junit.Test(timeout = 4000)
    public void test07() throws java.lang.Throwable {
        org.joda.time.tz.FixedDateTimeZone fixedDateTimeZone0 = ((org.joda.time.tz.FixedDateTimeZone)(org.joda.time.DateTimeZone.forOffsetHours(((byte)(-128)))));
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(((long)((byte)(2))) , ((org.joda.time.Chronology)(islamicChronology0)) , locale0 , ((java.lang.Integer)(islamicChronology0.AH)) , 1);
        dateTimeParserBucket0.setOffset((-3236));
        dateTimeParserBucket0.getOffsetInteger();
        org.junit.Assert.assertEquals((-3236), dateTimeParserBucket0.getOffset());
    }
    ...
    public void test09() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(4588L , ((org.joda.time.Chronology)(buddhistChronology0)) , locale0);
        dateTimeParserBucket0.setOffset((-2904));
        int int0 = dateTimeParserBucket0.getOffset();
        org.junit.Assert.assertEquals((-2904), int0);
    }

    @org.junit.Test(timeout = 4000)
    public void test10() throws java.lang.Throwable {
        java.util.Locale locale0 = java.util.Locale.TRADITIONAL_CHINESE;
        java.lang.Integer integer0 = new java.lang.Integer(3983);
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(1175378400000L , ((org.joda.time.Chronology)(null)) , locale0 , integer0 , 3983);
        long long0 = dateTimeParserBucket0.computeMillis(true, "");
        org.junit.Assert.assertEquals(1175371200000L, long0);
    }
    ...
    public void test12() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(11688L , ((org.joda.time.Chronology)(islamicChronology0)) , locale0 , ((java.lang.Integer)(1)) , (-1076));
        long long0 = dateTimeParserBucket0.computeMillis();
        org.junit.Assert.assertEquals(11688L, long0);
    }
    ...
    public void test19() throws java.lang.Throwable {
        ...
        org.joda.time.chrono.GJChronology gJChronology0 = org.joda.time.chrono.GJChronology.getInstanceUTC();
        org.joda.time.DurationField durationField0 = durationFieldType0.getField(gJChronology0);
    ...
    public void test20() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket.SavedField dateTimeParserBucket_SavedField0 = new org.joda.time.format.DateTimeParserBucket.SavedField(dateTimeField0 , "America/Sao_Paulo" , locale0);
    ...
    public void test23() throws java.lang.Throwable {
        ...
        java.lang.Integer integer0 = new java.lang.Integer(76);
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-4945L) , ((org.joda.time.Chronology)(iSOChronology0)) , locale0 , integer0 , 4981);
    ...
    public void test26() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket.SavedField dateTimeParserBucket_SavedField0 = new org.joda.time.format.DateTimeParserBucket.SavedField(dateTimeField0 , 16);
    ...
    public void test28() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals(4587L, long0);
    }
    ...
    public void test29() throws java.lang.Throwable {
        ...
        long long0 = dateTimeParserBucket0.computeMillis(true);
        org.junit.Assert.assertEquals((-16187904000000L), long0);
    ...
    public void test30() throws java.lang.Throwable {
        ...
        org.joda.time.DateMidnight dateMidnight0 = org.joda.time.DateMidnight.now(((org.joda.time.DateTimeZone)(cachedDateTimeZone0)));
        org.joda.time.chrono.GJChronology gJChronology0 = org.joda.time.chrono.GJChronology.getInstance(((org.joda.time.DateTimeZone)(cachedDateTimeZone0)), ((org.joda.time.ReadableInstant)(dateMidnight0)));
        java.util.Locale locale0 = java.util.Locale.TRADITIONAL_CHINESE;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-1L) , ((org.joda.time.Chronology)(gJChronology0)) , locale0);
    ...
    public void test31() throws java.lang.Throwable {
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket((-2718L) , ((org.joda.time.Chronology)(ethiopicChronology0)) , ((java.util.Locale)(null)));
        org.joda.time.format.DateTimeParserBucket.SavedState dateTimeParserBucket_SavedState0 = dateTimeParserBucket0.new SavedState();
        ...
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket1 = new org.joda.time.format.DateTimeParserBucket((-1L) , ((org.joda.time.Chronology)(buddhistChronology0)) , ((java.util.Locale)(null)) , ((java.lang.Integer)(buddhistChronology0.BE)) , 1);
        org.joda.time.format.DateTimeParserBucket.SavedState dateTimeParserBucket_SavedState1 = dateTimeParserBucket1.new SavedState();
    ...
    public void test40() throws java.lang.Throwable {
        org.joda.time.chrono.BuddhistChronology buddhistChronology0 = org.joda.time.chrono.BuddhistChronology.getInstance();
        java.util.Locale locale0 = java.util.Locale.GERMANY;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(0L , ((org.joda.time.Chronology)(buddhistChronology0)) , locale0 , ((java.lang.Integer)(1)) , (-2734));
        java.lang.Integer integer0 = dateTimeParserBucket0.getPivotYear();
        org.junit.Assert.assertEquals(1, ((int)(integer0)));
    }
    ...
    public void test44() throws java.lang.Throwable {
        ...
        java.util.Locale locale0 = java.util.Locale.JAPANESE;
        org.joda.time.format.DateTimeParserBucket dateTimeParserBucket0 = new org.joda.time.format.DateTimeParserBucket(((long)(1)) , ((org.joda.time.Chronology)(buddhistChronology0)) , locale0 , ((java.lang.Integer)(1)) , 535);
        org.joda.time.format.DateTimeParserBucket.SavedState dateTimeParserBucket_SavedState0 = dateTimeParserBucket0.new SavedState();
